...
export default function TSignup2({ navigation, route }) {
      ...
      .then((userCredential) => {
        ...
        db.collection("users")
          ...
          .set({
            ...
            active: "true",
            profile:
              "https://firebasestorage.googleapis.com/v0/b/socialapp-e7b5f.appspot.com/o/defaultProfile%2Fteacher.png?alt=media&token=7a203e77-2ea4-4ac1-9484-67e32b209ca1",
          })
          .then((docRef) => {
            setLoading(false);
